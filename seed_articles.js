const url = "https://emczpmofnkztaqnwbdwn.supabase.co/rest/v1/articles";
const key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVtY3pwbW9mbmt6dGFxbndiZHduIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTkwMTU2NjgsImV4cCI6MjA3NDU5MTY2OH0.OqZVGq5ZPIKGoeuucA1_UZJZTAskkvO3HFyq6QLDiXY";
...
By committing to this path, we honor the ancient lineage of teachers who preserved these practices through the millennia. We become links in a living chain of wisdom, carrying the light of yoga forward into the future. It is a lifelong journey of learning, unlearning, and profound transformation.`;
  ...
  // Repeat or extend to ensure it's comfortably over 300 words.
...
async function seed() {
  console.log("Seeding 15 articles...");
  for (const article of articles) {
    ...
    if (!response.ok) {
      console.error("Failed to insert article:", article.title, await response.text());
    } else {
